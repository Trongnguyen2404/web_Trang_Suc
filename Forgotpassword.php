...
<div data-aos="fade-down-right" data-aos-duration="2000" style="
    position: absolute;
    background: #00dcff;
    width: 400px;
    height: 400px;
...
"></div>
<div data-aos="fade-down-left" data-aos-duration="2000" style="
    position: absolute;
    background: #00dcff;
    width: 400px;
    height: 400px;
...
"></div>
<div data-aos="fade-up-right" data-aos-duration="2000"  style="
    position: absolute;
    background: #00dcff;
    width: 400px;
    height: 400px;
...
"></div>
<div data-aos="fade-up-left" data-aos-duration="2000" style="
    position: absolute;
    background: #00dcff;
    width: 400px;
    height: 400px;
...
"></div>
<form data-aos="zoom-in" data-aos-duration="2000" action="xulyquenpass.php" method="post" class="col-5 m-auto bg-secondary p-2 text-white">
